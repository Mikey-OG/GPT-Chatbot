        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, fetch("/api/uploadPdf", {
                            method: "POST",
                            body: formData
                        })];
                case 1:
...
//   const onDrop = useCallback(async (event: React.ChangeEvent<HTMLInputElement>) => {
...
//       return alert("Error handling file upload");
...
//                   >
//                     <input type="file" accept=".pdf" onChange={onDrop} />
